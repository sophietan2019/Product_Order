...
namespace ProductAndOrder.NorthwindDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ProductAndOrder.Properties.Settings.Default.NorthwindConnectionString;
        }
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual int SearchByProductID(NorthwindDataSet.ProductsDataTable dataTable, int ProductID) {
